...
import { ShoppingCart, Sparkles, Clock, Star, ChefHat, Heart } from "lucide-react"
                ...
                <div className="relative">
                    ...
                    <div className="relative ">
                        ...
                        >
                            ...
                            >
                                <ShoppingCart className="w-16 h-16 text-orange-500 drop-shadow-lg" />
                            </motion.div>
                        </motion.div>
                    ...
                    <div className="relative">
                        ...
                        >
                            Browse our delicious menu and start building your perfect meal with{" "}
                            <span className="text-orange-500 font-medium">authentic Indian flavors</span>
                        </motion.p>
