...
const sampleTestimonial = {
  ...
  image: "/user.png",
  quote:
    "Food Dash is simply amazing. Their UI is smooth and responsive, and the signup process was quick and hassle-free!",
  stars: 5,
};
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        toast.success("Welcome To FOOD DASH !!", {
          description: "Hope your taste buds have a party!!"
        });
        navigate("/auth/login");
      }
    } catch (error) {
